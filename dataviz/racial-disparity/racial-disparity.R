...
# read race and ethnicity data from 2020 census
dc_demographics <- get_acs(
  geography = "block group",
  variables = c("B02001_002","B02001_003", "B02001_004", "B02001_005", "B02001_006", # race
...
ggsave("dc_race.png", width = 14, height = 14/1.618, units = "in")

## Approach 2: filled image plot

# Across these 293 communities that were exposed to gun violence, 4 were Hispanic/Latino communities, 289 were non-Hispanic/non-Latino communities
# 555 communities in total, 5 were Hispanic/Latino communities (4/5 = 80%), 550 were others (289/550 = 53%)
...
hispanic %>% 
  ...
  e_legend(show = FALSE) %>%
  e_grid(bottom = "35%") # increase spacing below the graph
# save the graph by click on the "download" icon

# load the saved image and make annotations
library(magick)
library(ggpubr)
